...
const labWorkflows: LabWorkflow[] = [
  ...
  {
    id: "leadpulse-lead-engine",
    name: "LeadPulse B2B Prospecting & Outreach Pipeline",
    badge: "Serper API · n8n · Supabase CRM",
    description:
      "Autonomous B2B lead generation workflow. Takes campaign parameters (service, niche, locations), queries Google Places via Serper API, performs 4-tier deduplication, enriches contact emails, generates GPT-4o-mini personalized pitches, and upserts directly into Supabase PostgreSQL.",
    nodes: [
      {
        id: "campaign-trigger",
        label: "CRM Campaign Launch",
        type: "trigger",
        icon: Workflow,
        system: "Next.js CRM Webhook Trigger",
        details: {
          input: '{"service": "Website Redesign", "niche": "Salons", "locations": ["Dubai, UAE"], "quantity": 25, "filters": {"phone": true, "email": true}}',
          processing: "n8n Webhook Listener receives campaign parameters, dispatches HTTP 202 Accepted, and registers campaign in Supabase with 'running' status.",
          modelOrTool: "n8n Webhook Gateway + Supabase Client",
          output: '{"campaignId": "camp_ae8921", "status": "running", "targetCombinations": 3, "requiredBatches": 2}',
        },
      },
      {
        id: "places-ingest",
        label: "Serper Places Matrix & Ingest",
        type: "database",
        icon: Database,
        system: "Serper Places API (Google Maps Graph)",
        details: {
          input: 'Query: "beauty salon Dubai UAE", pagination page: 1, limit: 20',
          processing: "Queries Google Maps business graph via Serper. Normalizes Place ID, business title, rating, review count, latitude/longitude, and raw phone.",
          modelOrTool: "Serper Places API + JSON Normalizer",
          output: "20 raw business records with Google rating 4.9+, phone numbers, and physical coordinates.",
        },
      },
      {
        id: "dedup-enrich",
        label: "4-Tier Deduplication & Email Discovery",
        type: "logic",
        icon: Layers,
        system: "Deduplication Engine & Serper Search",
        details: {
          input: "20 normalized local business entities.",
          processing: "Executes 4-tier dedup: Place ID, E.164 phone, root domain, and name+city. Queries targeted domain search to extract direct verified emails (info@, contact@) and social URLs.",
          modelOrTool: "Regex Email Extractor & Serper Search Node",
          output: "Clean unique leads with 100% phone coverage and verified company contact emails.",
        },
      },
      {
        id: "ai-pitch-gen",
        label: "GPT-4o-mini Pitch Generator",
        type: "ai",
        icon: Bot,
        system: "OpenRouter / GPT-4o-mini",
        details: {
          input: 'Business: "The Nest Salon, Jumeirah", Rating: 4.9, Reviews: 184, Website: Active, Service: "Website Redesign"',
          processing: "Evaluates digital readiness score (110 - High Intent). Generates tailored, non-spammy cold pitch addressing specific high-end salon positioning and booking conversion gaps.",
          modelOrTool: "OpenRouter API (openai/gpt-4o-mini)",
          output: '{"leadScore": 110, "tier": "High Intent", "pitch": "Hi team at The Nest Salon! Loved your 4.9-star reviews in Jumeirah. Noticed your booking flow could convert 30% more mobile visitors..."}',
        },
      },
      {
        id: "crm-outreach-sync",
        label: "Supabase CRM & 1-Click Outreach",
        type: "output",
        icon: Cpu,
        system: "Supabase PostgreSQL Hub & Outreach Hub",
        details: {
          input: "Enriched leads with score 110, verified contact info, and custom outreach pitch.",
          processing: "Upserts leads to public.leads table; Supabase Realtime notifies Next.js dashboard; pre-fills 1-click WhatsApp and Gmail outreach buttons in the Outreach Hub.",
          modelOrTool: "Supabase PostgreSQL + WhatsApp/Gmail URL Handlers",
          output: "Campaign marked completed; 12 High-Intent leads instantly actionable in the live LeadPulse CRM dashboard.",
        },
      },
    ],
  },
